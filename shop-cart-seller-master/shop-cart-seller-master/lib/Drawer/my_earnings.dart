...
class _MyEarningsPageState extends State<MyEarningsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    List<RecentTransaction> transactions = [
      RecentTransaction('assets/ProductImages/item1.png', locale.blackCottonTop,
          '124', '378.00', Colors.green),
      RecentTransaction('assets/ProductImages/item2.png',
          locale.summerFullSleeveTshirt, '119', '279.00', Colors.green),
      RecentTransaction('assets/ProductImages/item3.png', locale.sendToBank,
          '124', '235.00', Colors.red),
      RecentTransaction('assets/ProductImages/item4.png',
          locale.pinkCottonTShirt, '124', '159.00', Colors.green),
      RecentTransaction('assets/ProductImages/item4.png',
          locale.pinkCottonTShirt, '124', '159.00', Colors.green),
      RecentTransaction('assets/ProductImages/item4.png',
          locale.pinkCottonTShirt, '124', '159.00', Colors.green),
            ...
            Padding(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Container(
                    child: FadedScaleAnimation(Image.asset(
                      'assets/Chart.png',
                      fit: BoxFit.fill,
                    )),
                    height: 200,
