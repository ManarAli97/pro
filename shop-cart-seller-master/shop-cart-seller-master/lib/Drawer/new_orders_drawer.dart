...
import 'package:shopcart_seller/Pages/Other/product_info.dart';
...
class _NewOrdersDrawerState extends State<NewOrdersDrawer> {
  ...
  Widget build(BuildContext context) {
    ...
    List<NewOrderItem> newOrders = [
      NewOrderItem('assets/ProductImages/item7.png', locale.hairDryer,
          'Samantha Smith | New York, USA'),
      NewOrderItem('assets/ProductImages/item6.png', locale.blackCottonTop,
          'Emili Williamson | Hemilton, USA'),
      NewOrderItem('assets/ProductImages/item5.png',
          locale.summerFullSleeveTshirt, 'George Taylor | New York, USA'),
      NewOrderItem('assets/ProductImages/item3.png', locale.floralPrintShirt,
          'Samantha Smith | New York, USA'),
      NewOrderItem('assets/ProductImages/item7.png', locale.hairDryer,
          'Samantha Smith | New York, USA'),
      NewOrderItem('assets/ProductImages/item6.png', locale.blackCottonTop,
      ...
      child: Card(
        ...
        child: Column(
          children: [
            ...
            buildOrderInfoRow(context, '\$14.00', 'TST11414', locale.pending!),
          ],
        ),
      ),
    );
