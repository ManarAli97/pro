...
class _InsightPageState extends State<InsightPage> {
  ...
  Widget build(BuildContext context) {
    ...
    List<TopSellingItem> topSellingItems = [
      TopSellingItem('assets/ProductImages/item1.png', locale.blackCottonTop, '124', '378.00'),
      TopSellingItem('assets/ProductImages/item2.png', locale.summerFullSleeveTshirt, '119', '279.00'),
      TopSellingItem('assets/ProductImages/item3.png', locale.floralPrintShirt, '124', '235.00'),
      TopSellingItem('assets/ProductImages/item4.png', locale.blackCottonTop, '124', '159.00'),
    ];
    return Scaffold(
      ...
      body: Stack(
        children: [
          Image.asset('assets/header.png',height: 180,width:MediaQuery.of(context).size.width,fit: BoxFit.fill,),
          Padding(
          ...
          Padding(
            ...
            child:ListView(
              ...
              children: [
                SizedBox(height: 15,),
                Container(
                  child: Image.asset('assets/Chart.png',fit: BoxFit.fill,),
                  height: 200,
