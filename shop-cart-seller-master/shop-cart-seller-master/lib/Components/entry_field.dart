...
class _EntryFieldState extends State<EntryField> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: widget.horizontalPadding??20.0, vertical: widget.verticalPadding??5.0),
      child: Column(
          ...
          TextField(
            ...
            decoration: InputDecoration(
              enabledBorder: UnderlineInputBorder(
                ...
                hintStyle: widget.hintStyle??Theme.of(context)
                    .textTheme
                    .subtitle2!
                    .copyWith(fontSize: 18.3)),
          ),
