...
import 'package:shopcart/Pages/Other/add_review.dart';
...
class _MyOrdersDrawerState extends State<MyOrdersDrawer> {
  ...
  Widget build(BuildContext context) {
    ...
    List<MyOrderItem> myOrders = [
      MyOrderItem('assets/ProductImages/item7.png', locale.hairDryer),
      MyOrderItem('assets/ProductImages/item6.png', locale.yellowDress),
      MyOrderItem('assets/ProductImages/item5.png', locale.checkShirt),
      MyOrderItem(
          'assets/ProductImages/item3.png', locale.summerFullSleeveTshirt),
    ];
      ...
      body: ListView(
        ...
        children: [
          Card(
            ...
            child: Column(
              children: [
                buildItem(context, 'assets/ProductImages/item4.png',
                    locale.blackCottonTop!, 'Operum England'),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildAmountRow(locale.pinkCottonShirt!, '\$28.00'),
                      SizedBox(
                        height: 5,
                      ),
                      Text('Qnt. 1',
          ...
          ListView.builder(
              ...
              itemBuilder: (context, index) {
                return buildCompleteCard(context, myOrders[index].img,
                    myOrders[index].name!, 'Jonathon Techs');
              }),
        ],
      ),
    );
  ...
  CircleAvatar buildStatusIcon(IconData icon, {bool disabled = false}) =>
      CircleAvatar(
          radius: 16,
          backgroundColor: !disabled ? Color(0xff222e3e) : Colors.grey[600],
          child: Icon(
            icon,
            size: 18,
            color: !disabled
      ...
      child: Card(
        ...
        child: Column(
          children: [
            ...
            buildOrderInfoRow(
                context, '\$14.00', locale.cashOnDelivery!, locale.delivered!),
          ],
        ),
      ),
    );
